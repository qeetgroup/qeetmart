...
export function SidebarNav({ sections, idPrefix = "sidebar-section" }: SidebarNavProps) {
    ...
    >
      {sections.map((section, sectionIndex) => {
        ...
        return (
          ...
          >
            <button
              aria-controls={`${idPrefix}-${sectionKey}`}
            ...
            <ul className={cn("space-y-1", isCollapsed ? "hidden" : "")} id={`${idPrefix}-${sectionKey}`}>
