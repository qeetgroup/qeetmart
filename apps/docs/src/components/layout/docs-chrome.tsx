  ...
  return (
    <div className="min-h-dvh bg-background">
      ...
      <div className="mx-auto grid w-full max-w-[1600px] lg:grid-cols-[18rem_minmax(0,1fr)]">
        <aside className="border-b border-border/80 bg-sidebar/70 px-3 py-4 lg:sticky lg:top-14 lg:h-[calc(100dvh-3.5rem)] lg:overflow-y-auto lg:border-r lg:border-b-0 lg:px-4 lg:py-6">
